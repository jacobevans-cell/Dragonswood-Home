...
function ensureFirebase(){if(!window.firebase)throw new Error('Dragonswood Firebase did not load.');if(!firebase.apps.length)firebase.initializeApp({apiKey:'AIzaSyD-qVZO23L3qgYItNfone4yEdouywF4BXU',authDomain:'dragonswood-home.firebaseapp.com',projectId:'dragonswood-home',storageBucket:'dragonswood-home.firebasestorage.app',messagingSenderId:'2486017303',appId:'1:2486017303:web:1bf3893e6b6d6b6530eb52',measurementId:''});return firebase.app();}
