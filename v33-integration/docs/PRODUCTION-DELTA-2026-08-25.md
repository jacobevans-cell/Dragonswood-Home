...
Current production still uses Firebase Web SDK 12.1.0, project `dragonswood-home`, the Explore Academy student domain, and the exact teacher email. The student shell additionally gained pending-extra-pass tracking, classroom/focus helpers, and updated subpage shell behavior. V3.3 may not regress any of those.
