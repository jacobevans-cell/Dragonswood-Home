...
if rg -n 'dragonswood-home' "$ROOT/firestore.gate.rules" "$ROOT/tools/teacher-operations-browser-gate.py" "$ROOT/js/integration/operations.js" "$ROOT/js/integration/narration.js"; then
